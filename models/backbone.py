...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str, train_backbone: bool, return_interm_layers: bool, dilation: bool):
        backbone = getattr(torchvision.models, name)(
            replace_stride_with_dilation=[False, False, dilation], weights="IMAGENET1K_V2", norm_layer=FrozenBatchNorm2d
        )
...
class GroupNormBackbone(BackboneBase):
    ...
    def __init__(self, name: str, train_backbone: bool, return_interm_layers: bool, dilation: bool):
        ...
        backbone = getattr(torchvision.models, name_map[name][0])(
            replace_stride_with_dilation=[False, False, dilation], weights=None, norm_layer=GroupNorm32
        )
